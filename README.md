...
>вебчик: "даю тебе фронтенд. идентифицирую тебя по cookie session https://echo.labstack.com/docs/cookies" и потом во всех запросах к логике калькулятора спрашиваю эту куку, смотрим в kv DB и если там нет такой куки то (перевыдать куки). Если куки нет то (перевыдать куки)
